...
- installs Redis or Valkey as appropriate for the OS if needed
- secures the cache service for localhost-only use
...
- **v2.6.10** is the current public production release
- Upgrades from any **v2.0.4+** install are in-place and one command
- The next milestone is **v2.7.x** (observability and debugging)
